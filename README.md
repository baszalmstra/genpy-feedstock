About genpy-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/genpy-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=349&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/genpy-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `genpy` can be installed with `conda`:
...
It is possible to list all of the versions of `genpy` available on your platform with `conda`:
...
```
mamba search genpy --channel conda-forge
```
...
mamba repoquery search genpy --channel conda-forge

# List packages depending on `genpy`:
mamba repoquery whoneeds genpy --channel conda-forge

# List dependencies of `genpy`:
mamba repoquery depends genpy --channel conda-forge
```
